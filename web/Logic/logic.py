...
def SetInstitutionFeatures(institution_id, feature_ids):
    for x in orm.InstitutionFeature.query.filter_by(
...
def SetDefaultImage(obj):
    if restful.ITEM_BULLETINIMAGES in obj:
        ...
        if len(listimage) <= 0:
            listimage.append({
                restful.ITEM_ID: 0,
                restful.ITEM_FILE: 'default_bulletinimage.jpg'
            })
    ...
    if restful.ITEM_INSTITUTIONIMAGES in obj:
        ...
        if len(listimage) <= 0:
            listimage.append({
                restful.ITEM_ID: 0,
                restful.ITEM_FILE: 'default_institutionimage.jpg'
            })
    ...
    if restful.ITEM_SCHOOLIMAGES in obj:
        ...
        if len(listimage) <= 0:
            listimage.append({
                restful.ITEM_ID: 0,
                restful.ITEM_FILE: 'default_schoolimage.jpg'
            })
